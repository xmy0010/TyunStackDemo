...
//            }]];
//            NSArray *first = self.gradeStringPaths.lastObject;
//            self.gradeStringPaths = @[].mutableCopy;
//            for (CATextLayer *layer in first) {
//                [layer removeFromSuperlayer];
//            }
//            for (NSMutableArray *arr in self.gradeStringPaths) {
//                [arr enumerateObjectsUsingBlock:^(CALayer * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
